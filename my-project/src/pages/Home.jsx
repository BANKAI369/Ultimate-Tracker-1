      ...
      <div className='w-full min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100'>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 w-full">
            ...
            {/* Reminders Section */}
            <div className="flex flex-col w-full rounded-2xl shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-300 bg-gradient-to-br from-blue-50 to-indigo-100 shadow-lg border border-blue-100">
